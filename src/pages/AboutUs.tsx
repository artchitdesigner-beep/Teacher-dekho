        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 py-20">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-32">
                    ...
                    <div className="bg-white dark:bg-slate-900 p-10 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-xl hover:shadow-emerald-100/30 dark:hover:shadow-none transition-all duration-500">
                        ...
                        <h2 className="text-2xl font-serif font-bold text-slate-900 dark:text-slate-100 mb-4">Our Vision</h2>
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                ...
                {/* Why Choose Us */}
                <section className="bg-slate-900 dark:bg-slate-800 rounded-[3rem] p-12 md:p-20 text-white shadow-2xl">
