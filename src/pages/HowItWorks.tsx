            ...
            <div className="max-w-7xl mx-auto px-6 py-20">
                ...
                <section className="mb-32">
                    <div className="flex items-center gap-3 mb-12">
                        <div className="w-12 h-12 bg-cyan-700 text-white rounded-2xl flex items-center justify-center shadow-lg shadow-cyan-700/20">
                            <Users size={24} />
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            {
                                icon: <Search className="text-cyan-700" size={32} />,
                            ...
                            {
                                icon: <Calendar className="text-cyan-700" size={32} />,
                            ...
                            {
                                icon: <Video className="text-cyan-700" size={32} />,
                            ...
                            <div key={index} className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-xl hover:shadow-cyan-100/50 dark:hover:shadow-none transition-all duration-300 group">
                ...
                {/* CTA Section */}
                <div className="bg-cyan-700 rounded-[3rem] p-12 md:p-20 text-center text-white relative overflow-hidden shadow-2xl shadow-cyan-700/20">
                    ...
                    <p className="text-lg text-cyan-100 mb-10 max-w-2xl mx-auto relative z-10">
                        Join thousands of students and teachers who are already transforming the way they learn and teach.
                    </p>
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 relative z-10">
                        <button className="px-8 py-4 bg-white text-cyan-700 font-bold rounded-2xl hover:bg-cyan-50 transition-all shadow-lg active:scale-95">
                            Find a Tutor
                        </button>
                        <button className="px-8 py-4 bg-cyan-500 text-white font-bold rounded-2xl hover:bg-cyan-400 transition-all border border-cyan-400 shadow-lg active:scale-95">
                            Become a Tutor
                        </button>
                    </div>
                </div>
